        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 md:gap-10">
          <div className="space-y-3">
            ...
            >
              ...
              commitment to making a meaningful difference in the lives of
              others, Annamitra strives to be the bridge between surplus food
                ...
                <p className="text-sm text-[#354e41] font-semibold flex items-center ">
                  ...
                  >
                    <img
                      ...
                      style={{ width: "22px", height: "22px", border: "2px solid #354e41", borderRadius: "4px" }}
                    />
        ...
        <div className="container grid items-center justify-center gap-4 px-4 py-12 md:px-6 md:py-24">
          <div className="space-y-3 text-center">
            ...
            >
              ...
              goes to bed hungry. We envision a future where access to
              nutritious meals is a fundamental human right, where every
              individual has the opportunity to thrive and reach their full
              potential without the burden of hunger weighing them down.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 py-12 md:px-6 md:py-24">
          <div className="space-y-3 text-center">
            ...
            <p
              ...
              style={{ color: "black" }}
            >
              Our mission drives everything we do at Annamitra. We are dedicated
              to connecting surplus food resources with individuals, families,
              and communities facing food insecurity. Through our innovative
              platform, we facilitate the seamless donation of surplus food from
              individuals, businesses, and organizations to local food banks,
              shelters, and community centers. Together, we work tirelessly to
              ensure that nutritious meals reach those who need them the most.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:gap-10">
          <div className="space-y-3 text-center">
            ...
            <p
              ...
              style={{ color: "black" }}
            >
              At Annamitra, our values guide our actions and decisions every
              step of the way. <br /> We believe in:
              <br />
              <ul className="">
                <li>
                  Compassion: We approach our work with empathy and
                  understanding, recognizing the dignity and worth of every
                  individual.
                </li>
                <li>
                  Collaboration: We foster partnerships and collaborations with
                  individuals, businesses, and organizations to maximize our
                  impact and reach.
                </li>
                <li>
                  Sustainability: We are committed to promoting environmentally
                  sustainable practices in our efforts to combat food
                  insecurity.
                </li>
                <li>
                  Accountability: We hold ourselves accountable for the trust
                  placed in us by our donors, recipients, and community
                  stakeholders.
                </li>
              </ul>
            </p>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 py-12 md:px-6 md:py-24">
          <div className="space-y-3 text-center">
            ...
            <p
              ...
              style={{ color: "black" }}
            >
              Join us in our mission to make a tangible difference in the fight
              against hunger. Whether you're a donor looking to contribute
              surplus food or a recipient in need of assistance, Annamitra
              welcomes you with open arms. Together, we can build a brighter,
              more nourished future for all.
            </p>
          </div>
        </div>
      </section>
