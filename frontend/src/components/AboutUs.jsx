...
export default function Component() {
    return (
      <div className="flex flex-col min-h-screen">
        <main className="grid items-center justify-center w-full flex-1 min-h-[450px] py-6">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 md:gap-10">
            <div className="space-y-3">
              ...
              <br /><br />
              <p className="mx-auto max-w-4xl text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-2xl/relaxed " style={{color:"black"}}>
        ...
        <section className="py-2 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:gap-10">
            <div className="space-y-3 text-center">
              ...
              <br /><br />
              <p className="mx-auto max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-2xl/relaxed dark:text-gray-400" style={{color:"black"}}>
        ...
        <section className="border-t">
          <div className="container grid items-center justify-center gap-4 px-4 py-12 md:px-6 md:py-24">
            <div className="space-y-3 text-center">
              ...
              <br /><br />
              <p className="mx-auto max-w-3xl text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-2xl/relaxed dark:text-gray-400"style={{color:"black"}}>
        ...
        <section className="py-12 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:gap-10">
            <div className="space-y-3 text-center">
              ...
              <br /> <br />
              <p className="mx-auto max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-2xl/relaxed dark:text-gray-400" style={{color:"black"}}>
              At Annamitra, our values guide our actions and decisions every step of the way. <br /> We believe in:
              <br />
              <ul className="">
        ...
        <section>
          <div className="container grid items-center justify-center gap-4 px-4 py-12 md:px-6 md:py-24">
            <div className="space-y-3 text-center">
              ...
              <br /><br />
              <p className="mx-auto max-w-[800px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-2xl/relaxed dark:text-gray-400" style={{color:"black"}}>
